package com.naruka.client.gui;

import com.naruka.client.config.ConfigManager;
import com.naruka.client.config.NarukaConfig;
import com.naruka.client.gui.widget.ColorPickerWidget;
import com.naruka.client.gui.widget.DropdownWidget;
import com.naruka.client.gui.widget.GuiWidget;
import com.naruka.client.gui.widget.KeybindWidget;
import com.naruka.client.gui.widget.SliderWidget;
import com.naruka.client.gui.widget.ToggleWidget;
...
/**
 * Naruka Client main menu: a 900x550 glass window with a 180px sidebar and a routed content area.
 *
...
public class ClickGuiScreen extends Screen {
	...
	public ClickGuiScreen() {
		super(Text.literal("Naruka Client"));
	...
	private void layout() {
		...
		// smaller than that, so the applied scale is additionally capped by what actually fits —
		// otherwise the sidebar and the close button would sit off-screen.
	...
	private void drawLogo(DrawContext context) {
		...
		RenderUtils.drawText(context, "Naruka Client", 0.0f, 0.0f, TEXT, true);
		context.getMatrices().popMatrix();
